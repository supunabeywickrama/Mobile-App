...
class appColor{
  static const Color homePageBackgraound = Color(0xFFfbfcff);
  ...
  static const Color secondPageTopIconColour = Color(0xFFb7bce8);
  static const Color secondPageTitleColor = Color(0xFFfefeff);
  static const Color secondPageContainerGradient1stColour = Color(0xff0f17ad);
  static const Color secondPageContainerGradient2stColour = Color.fromRGBO(97, 134, 246, 1);
  static const Color loopColor = Color(0xFF6d8dea);
  static const Color setColor = Color(0xFF9999a9);
  static const Color circuitColor = Color(0xFF2f2f51);
